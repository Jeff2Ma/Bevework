...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page( __('Bevework主题设置', 'options_framework_theme'), __('Bevework主题设置', 'options_framework_theme'), 'edit_theme_options', 'options-framework','optionsframework_page' );
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submit">
				...
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( '恢复默认', 'options_framework_theme' ); ?>" onclick="return confirm( '<?php print esc_js( __( '点击确定重置设置数据，之前所有的设置将消失！', 'options_framework_theme' ) ); ?>' );" />
				<div class="clear"></div>
			</div>
			</form>
		</div> <!-- / #container -->
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( '设置重置成功！', 'options_framework_theme' ), 'updated fade' );
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Bevework主题设置', 'options_framework_theme' ),
...
if ( ! function_exists( 'beve_option' ) ) {

	function beve_option( $name, $default = false ) {
